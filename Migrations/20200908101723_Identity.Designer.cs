...
namespace Tigers.Migrations
{
    ...
    [Migration("20200908101723_Identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tigers.Data.Entities.StoreUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("DutchTreat.Data.Entities.Order", b =>
                {
                    b.HasOne("Tigers.Data.Entities.StoreUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Tigers.Data.Entities.StoreUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
